class Sensor {
  ...
  Sensor() {
    ...
    sensorSmooth.calibrate((int)18.140955, (int)916.1677, (int)8.025766, (int)51.04799);
  ...
  void displayOverlay(int fontSize) {
  ...
  void calibrate(int pixelsPerStep, int size, int lowest, int highest) {
    sensorSmooth.calibrate(pixelsPerStep, size, lowest, highest); //<>//
  }
}
